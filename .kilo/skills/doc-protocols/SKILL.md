---
description: Documentation Protocols for AI-Friendly Artifacts — $DOCUMENT_PLAN skeleton,
  $START/$END tags, $ARTIFACT_CONTRACT, DevPlan protocol, artifact lifecycle, unified
  severity and verdict, XML knowledge graph
name: doc-protocols
---
