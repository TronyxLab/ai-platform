---
description: Python Engineering Rules — modern Python 3.14+, Pyright strict, typed
  data models, correct async, explicit lifecycle, LDD-compliant structured logging
