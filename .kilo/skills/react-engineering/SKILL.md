---
description: React Engineering Rules — function components and hooks, local and derived
  state, synchronization effects, stable identity, race-safe async, typed boundaries
