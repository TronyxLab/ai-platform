...
## ·   Статус на 2026-08-02 (DevPlan 119 D7): Rev-условие НЕ выполнено — production
## ·   НЕ верифицирован (test-VPS пересоздан 2026-08-02, проектов нет, ручное
## ·   тестирование запланировано ПОСЛЕ волны 119). НЕ удалять.
