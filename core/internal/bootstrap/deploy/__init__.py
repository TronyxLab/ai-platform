# GREP_SUMMARY: deploy, package, __init__, orchestrate, DeployResult, validate-secret-charsets, pre-pull-images, batch-check-env, check-env-requires, batch-generate-sudoers, batch-orphan-reconciliation, get-module-severity, public-api
# STRUCTURE: ┌deploy package┐ → ⚡ __all__ public contract ┌orchestrate + DeployResult + 7 публичных функций┐ → ⎋ re-export из home-модулей
...
## @scope    __all__: orchestrate + DeployResult (deploy_orchestrator) + 7 публичных функций
...
from core.internal.bootstrap.deploy.deploy_orchestrator import DeployResult, orchestrate
