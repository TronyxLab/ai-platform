...
##           Extracted from ssl-provision.sh (T3, DevPlan 005).
...
##            Split from ssl-provision.sh per D3: install-acme needed once at bootstrap,
##            issue-cert.sh needed at each update. Decoupling reduces update latency.
## @changes  CREATED: 2026-07-17 · T3 — Extracted from ssl-provision.sh (DevPlan 005)
...
# ═══════════════════════════════════════════════════════════════════
# NOTE: This script is extracted from core/internal/bootstrap/ssl-provision.sh.
# The install_acme() function was the first logical part of ssl-provision.sh.
