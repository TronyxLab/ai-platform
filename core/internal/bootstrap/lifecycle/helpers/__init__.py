...
##           subprocess_io.py УДАЛЁН (DevPlan 119 B4) — run_subprocess мигрирован в
##           shared/subprocess_io (единый канон; phases.py импортирует его напрямую).
## @invariants
...
##            B4 (DevPlan 119): subprocess_io.py — второй канон run_subprocess — удалён; все
##            bootstrap-фазы используют shared/subprocess_io (AC-B4.1/AC-B4.2).
...
subprocess_io.py deleted in DevPlan 119 B4 — run_subprocess lives in
core/internal/shared/subprocess_io.py (единый канон).
"""
