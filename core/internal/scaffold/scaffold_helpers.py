...
def gen_project_makefile(
    ...
    makefile_lines: list[str] = [
        ...
        "",
        "## project-check: Run practices checks (K1)",
        "project-check:",
        f"{tab}@$(MAKE) -C $(PLATFORM_DIR) project-check PROJECT=$(CURDIR)",
        "",
        "## project-fix: Auto-fix practices checks",
        "project-fix:",
        f"{tab}@$(MAKE) -C $(PLATFORM_DIR) project-fix PROJECT=$(CURDIR)",
        "",
...
- `make project-fix` — auto-fix practices checks
