...
## @changes 2026-08-01 | DevPlan 116 B1 T1 — Created (D1 verb-множество: legacy deliver-verb УДАЛЁН)
...
# ВАЖНО: legacy verbs (доставка через отдельный deliver-verb) УДАЛЕНЫ (DevPlan 116 D1/D2) — их здесь нет
# намеренно: любой такой вход → ConfigValidationError (unknown verb, честный exit 1).
