...
##           Создание docker-сетей — provision-environment.sh (первичный сетевой
##           провайдер; в lib дублей нет).
...
##           — REPLACES: inline docker_login()/ghcr_login() (единственный shell-канал логина)
...
## @changes   CREATED: 2026-07-09 · TASK-9 — Extracted from deploy-modules.sh
