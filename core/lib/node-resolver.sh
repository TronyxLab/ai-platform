...
## @scope    resolve_node_yaml: node_name ($1) — $2/$3 (platform_root/projects_dir) vestigial
##           УБРАНЫ (DevPlan 173 W3.2: поиск управляется env PLATFORM_ROOT/HOME в NodeYaml.resolve).
...
## @changes  2026-08-16 | DevPlan 173 W3.2 — vestigial $2/$3 (platform_root/projects_dir) убраны из доков
...
## @param $1  node_name (единственный — $2/$3 vestigial убраны, DevPlan 173 W3.2)
