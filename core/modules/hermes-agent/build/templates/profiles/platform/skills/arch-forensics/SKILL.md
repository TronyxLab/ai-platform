...
## @purpose  SKILL: Architecture Forensics — Staff Software Architect Pattern. Recover objective system architecture without fixes or refactoring. 7 core tasks + 9 superposition dimensions (S7–S15) for multi-hypothesis architectural analysis.
## @scope    architect, qa
## @invariants
##   - @protected  true
