...
# STRUCTURE: ▶ test_deep_mode_has_early_exit → ◇ test_litellm_uses_check_http → ◇ test_langfuge_uses_127_0_0_1 → ◇ test_postgres_deep_includes_pgbouncer → ◇ test_logging_deep_includes_promtail
...
class TestHealthcheckContract:
    ...
    def test_logging_deep_includes_promtail(self) -> None:
        """logging healthcheck.sh deep проверяет promtail /ready."""
        # 🧪 TRAP[TEST] · 2026-07-15 · gate/healthcheck-contract · Регресс: logging deep-блок утратил promtail /ready
