...
def test_gate_provisioner_idempotent(gate_policy, gate_client, tmp_path, caplog):
    ...
    with caplog.at_level(logging.DEBUG):  # ruff: ignore[PLR1702] — DI-patch-вложенность (caplog→patch×3) структурно неизбежна в gate-тесте
        ...
        with patch.object(kp, "LiteLLMAdminClient", return_value=gate_client):  # ruff: ignore[SIM117]
