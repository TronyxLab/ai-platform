...
class TestD5NegativeValidateModule:
    ...
    def test_wrong_env_requires_type(self, tmp_path, caplog):  # ruff: ignore[ARG002]
    ...
    def test_missing_required_env_var(self, tmp_path, caplog):  # ruff: ignore[ARG002]
    ...
    def test_restart_drift(self, tmp_path, caplog):  # ruff: ignore[ARG002]
    ...
    def test_d4_bare_string_still_valid(self, tmp_path, caplog):  # ruff: ignore[ARG002]
