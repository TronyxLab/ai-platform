...
class TestFileStructure:
    ...
    @ldd_trajectory
    def test_platform_env_yaml_exists(self, caplog) -> None:  # ruff: ignore[ARG002]
    ...
    @ldd_trajectory
    def test_platform_env_yaml_is_valid_yaml(self, caplog) -> None:  # ruff: ignore[ARG002]
...
class TestNetworksSchema:
    ...
    @ldd_trajectory
    def test_networks_section_exists(self, env_data: dict, caplog) -> None:  # ruff: ignore[ARG002]
    ...
    @ldd_trajectory
    def test_networks_name_field_required(self, env_data: dict, caplog) -> None:  # ruff: ignore[ARG002]
    ...
    @ldd_trajectory
    def test_networks_optional_fields(self, env_data: dict, caplog) -> None:  # ruff: ignore[ARG002]
    ...
    @ldd_trajectory
    def test_networks_minimum_count(self, env_data: dict, caplog) -> None:  # ruff: ignore[ARG002]
    ...
    @ldd_trajectory
    def test_no_duplicate_networks(self, env_data: dict, caplog) -> None:  # ruff: ignore[ARG002]
    ...
    @ldd_trajectory
    def test_network_names_format(self, env_data: dict, caplog) -> None:  # ruff: ignore[ARG002]
...
class TestVolumesSchema:
    ...
    @ldd_trajectory
    def test_volumes_section_exists(self, env_data: dict, caplog) -> None:  # ruff: ignore[ARG002]
    ...
    @ldd_trajectory
    def test_volumes_path_field_required(self, env_data: dict, caplog) -> None:  # ruff: ignore[ARG002]
    ...
    @ldd_trajectory
    def test_volumes_minimum_count(self, env_data: dict, caplog) -> None:  # ruff: ignore[ARG002]
    ...
    @ldd_trajectory
    def test_no_duplicate_volumes(self, env_data: dict, caplog) -> None:  # ruff: ignore[ARG002]
...
class TestEnvDefaultsSchema:
    ...
    @ldd_trajectory
    def test_env_defaults_section_exists(self, env_data: dict, caplog) -> None:  # ruff: ignore[ARG002]
    ...
    @ldd_trajectory
    def test_env_defaults_keys_format(self, env_data: dict, caplog) -> None:  # ruff: ignore[ARG002]
    ...
    @ldd_trajectory
    def test_env_defaults_values_are_strings(self, env_data: dict, caplog) -> None:  # ruff: ignore[ARG002]
    ...
    @ldd_trajectory
    def test_env_defaults_minimum_count(self, env_data: dict, caplog) -> None:  # ruff: ignore[ARG002]
...
class TestProfilesSchema:
    ...
    @ldd_trajectory
    def test_profiles_section_exists(self, env_data: dict, caplog) -> None:  # ruff: ignore[ARG002]
    ...
    @ldd_trajectory
    def test_profiles_match_modules_dir(self, env_data: dict, caplog) -> None:  # ruff: ignore[ARG002]
    ...
    @ldd_trajectory
    def test_profiles_minimum_count(self, env_data: dict, caplog) -> None:  # ruff: ignore[ARG002]
...
class TestCrossSectionConsistency:
    ...
    @ldd_trajectory
    def test_env_defaults_do_not_contain_dot_env_keys(self, env_data: dict, caplog) -> None:  # ruff: ignore[ARG002]
        """env_defaults contract: PLATFORM_DOMAIN present (SoT per DevPlan 116 D4).
        ...
        (R2-тавтология forbidden_in_defaults = set() удалена DevPlan 171 W3.7 —
        пустой перечень ничего не проверяет; появление production-only ключа в
        env_defaults ловит domain-parity/env-example-drift гейты.)
        """
        env_defaults = env_data.get("env_defaults", {})
        ...
        logger.info("[IMP:9][gate][platform-env] PLATFORM_DOMAIN SoT present ✓")
