...
#              This mirrors _reconfigure_monitoring() pattern from platform-deploy.sh.
#
...
##            Mirrors _reconfigure_monitoring() pattern from platform-deploy.sh.
...
def l1_path() -> str:
    ...
    return os.path.join(_TEST_DATA_DIR, "config_l1_defaults.yaml")


@pytest.fixture
def l2_path() -> str:
    """Path to L2 overrides test data file."""
    return os.path.join(_TEST_DATA_DIR, "config_l2_overrides.yaml")


@pytest.fixture
def l3_path() -> str:
    """Path to L3 project overrides test data file."""
    return os.path.join(_TEST_DATA_DIR, "config_l3_project.yaml")
...
def test_l1_defaults_exist(l1_path: str, caplog) -> None:
    ...
    with caplog.at_level(logging.DEBUG):
        ...
        assert os.path.isfile(l1_path), f"L1 defaults file not found: {l1_path}"
