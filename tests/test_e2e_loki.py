# GREP_SUMMARY: e2e loki labels log-query promtail pushing grafana-proxy basic-auth
...
def test_loki_labels(LOKI_PROXY_URL: str, grafana_credentials: tuple[str, str], caplog) -> None:
    ...
    if not label_set:
        # ⚠️ TRAP[LOCAL] · 2026-07-08 · — · No Loki labels — promtail may not be running
        # ·   on macOS Docker Desktop due to /var/log/nginx bind mount limitation.
        # ·   Production should have labels from promtail log collection.
        logger.warning(
