...
# · 2026-08-06 | 94 — ночная сессия 141: DOCKER_HUB_AUTH (CI env-хойст secrets, platform-test.yml)
# · Prevention: keep this constant in sync when adding env_defaults; parity asserts below catch key/value drift
EXPECTED_ENV_DEFAULTS_COUNT: int = (
    94  # +3 (RC 121): NODE_CONFIGS_DIR/STATUS_METRICS_JSON/HTPASSWD_FILE (локальные оверрайды, пустые дефолты)
)
