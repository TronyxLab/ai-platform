...
class TestProvisionSmoke:
    ...
    def test_provision_and_compose_up(self, caplog) -> None:
        ...
        logger.info("[IMP:7][smoke][provision] Running provisioner --scope networks")
        ...
        logger.info("[IMP:7][smoke][provision] Provisioner --scope networks: OK")
        ...
        logger.info("[IMP:7][smoke][provision] Provisioner --scope volumes: OK")
        ...
        logger.info("[IMP:9][smoke][provision] Full provision cycle: PASS")
