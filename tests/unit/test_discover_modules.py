...
def test_update_compose_include_changed(temp_compose_file):
...
def test_update_compose_include_idempotent(temp_compose_file):
...
def test_update_compose_include_preserves_other_sections(temp_compose_file):
