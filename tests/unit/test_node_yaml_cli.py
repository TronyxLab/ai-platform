...
## @purpose  Unit tests for core/internal/shared/node_yaml/cli.py — CLI commands extracted from
##           node_yaml.py (DevPlan 117 G T51; 170 W10-B: node_yaml_cli.py → node_yaml/cli.py).
##           Tests exercise each _cli_* function via mock NodeYaml.
...
## @changes  2026-08-15 · DevPlan 170 W10-B — import: node_yaml_cli → node_yaml.cli
...
from core.internal.shared.node_yaml import cli as node_yaml_cli
...
class TestCliGet:
    ...
    def test_cli_get_returns_value(self, capsys) -> None:
...
class TestCliMisc:
    ...
    def test_cli_typed_flags_removed(self, tmp_path) -> None:
    ...
    # · Expect: field:value lines (format, backward compat)
    # · Last fail: None (new test for DevPlan 117 G T51)
...
class TestCliValidateAndMain:
    ...
    def test_main_validation_error_exit4(self, capsys, tmp_path) -> None:
        ...
        with (
            mock.patch(
                "core.internal.shared.node_yaml.cli.sys.argv", ["node_yaml", "--get", "x", "--file", str(yaml_file)]
            ),
            mock.patch.object(node_yaml_cli.NodeYaml, "__init__", return_value=None),
            mock.patch(
                "core.internal.shared.node_yaml.cli._cli_get",
    ...
    def test_main_config_not_found_exit2(self, capsys, tmp_path) -> None:
        ...
        with (
            mock.patch(
                "core.internal.shared.node_yaml.cli.sys.argv",
    ...
    def test_main_resolve_no_file(self) -> None:
        """main() --resolve without --file → exit 0."""
        with (
            mock.patch(
                "core.internal.shared.node_yaml.cli.sys.argv", ["node_yaml", "--resolve", "--resolve-node", "foo"]
            ),
            mock.patch(
                "core.internal.shared.node_yaml.cli._cli_resolve",
                return_value=0,
            ) as mock_resolve,
        ):
            rc = node_yaml_cli.main()
