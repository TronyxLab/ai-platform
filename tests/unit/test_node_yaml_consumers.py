...
# исключая сам node_yaml/ пакет — CLI (node_yaml/cli.py) re-export'ится через __getattr__;
# 170 W10-B: node_yaml_cli.py → node_yaml/cli.py (внутри пакета)).
...
CONSUMERS = [
    ...
    "core.internal.shared.node_yaml.cli",
