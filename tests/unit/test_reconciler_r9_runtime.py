...
@ldd_trajectory
def test_reconcile_runtime_running(tmp_path, caplog, node_yaml_with_modules, mock_modules_dir, monkeypatch):
...
@pytest.mark.usefixtures("reset_state")
@ldd_trajectory
def test_reconcile_runtime_exited(tmp_path, caplog, node_yaml_with_modules, mock_modules_dir, monkeypatch):
...
@pytest.mark.usefixtures("reset_state")
@ldd_trajectory
def test_reconcile_runtime_cooldown(tmp_path, caplog, node_yaml_with_modules, mock_modules_dir, monkeypatch):
