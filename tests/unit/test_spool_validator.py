...
def _create_module_yaml(
    ...
    (mod_dir / "module.yaml").write_text(yaml.dump(cfg), encoding="utf-8")
...
def test_all_dirs_exist(tmp_path, caplog) -> None:
    ...
    logger.info("[IMP:9][test_all_dirs_exist] PASS: all dirs exist → status=ok")
...
def test_some_dirs_missing(tmp_path, caplog) -> None:
    ...
    logger.info("[IMP:9][test_some_dirs_missing] PASS: missing dirs → status=warn")
...
def test_spool_dir_none_stateless(tmp_path, caplog) -> None:
    ...
    logger.info("[IMP:9][test_spool_dir_none_stateless] PASS: spool_dir: none → stateless")
...
def test_minio_spool_dir_none_stateless(tmp_path, caplog) -> None:
    ...
    logger.info("[IMP:9][test_minio_spool_dir_none_stateless] PASS: minio spool_dir:none → stateless")
...
def test_removed_host_path_negative(tmp_path, caplog) -> None:
    ...
    logger.info("[IMP:9][test_removed_host_path_negative] PASS: removed host path → missing (negative)")
...
def test_spool_volume_skip(tmp_path, caplog) -> None:
    ...
    logger.info("[IMP:9][test_spool_volume_skip] PASS: spool_volume found in result")
...
def test_modules_dir_not_found(tmp_path, caplog) -> None:
    ...
    logger.info("[IMP:9][test_modules_dir_not_found] PASS: missing modules_dir → status=error")
...
def test_observability_module_triggers_obs_dirs(tmp_path, caplog) -> None:
    ...
    logger.info(
        "[IMP:9][test_observability_module_triggers_obs_dirs] PASS: observability module triggers obs dir check"
    )
...
def test_no_observability_module_skips_obs_dirs(tmp_path, caplog) -> None:
    ...
    logger.info("[IMP:9][test_no_observability_module_skips_obs_dirs] PASS: no observability module → obs dirs skipped")
...
def test_verify_only_no_mkdir(tmp_path, caplog) -> None:
    ...
    assert not Path(missing_dir).exists(), f"verify_spool_dirs() must NOT create directories! Found: {missing_dir}"

    logger.info("[IMP:9][test_verify_only_no_mkdir] PASS: verify_spool_dirs() did not create any directories")
...
def test_json_output_format(tmp_path, caplog) -> None:
    ...
    logger.info("[IMP:9][test_json_output_format] PASS: JSON output valid with all required keys")
...
def test_empty_modules_dir_no_yaml(tmp_path, caplog) -> None:
    ...
    logger.info("[IMP:9][test_empty_modules_dir_no_yaml] PASS: empty modules dir handled cleanly")
